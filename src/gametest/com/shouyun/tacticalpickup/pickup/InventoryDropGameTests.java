...
public final class InventoryDropGameTests {
	...
	@GameTest(template = "empty", batch = "inventoryDropA")
	...
	@GameTest(template = "empty", batch = "inventoryDropB")
	...
	@GameTest(template = "empty", batch = "inventoryDropC")
	...
	@GameTest(template = "empty", batch = "inventoryDropD")
	...
	@GameTest(template = "empty", batch = "inventoryDropE")
	...
	@GameTest(template = "empty", batch = "inventoryDropF")
	...
	@GameTest(template = "empty", batch = "inventoryDropG")
