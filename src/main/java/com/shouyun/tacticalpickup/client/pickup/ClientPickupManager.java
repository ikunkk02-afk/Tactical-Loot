...
public final class ClientPickupManager {
	...
	public boolean requestPickup(int representativeEntityId, int requestedAmount) {
		...
		PickupNetworking.sendPickup(new PickupRequestPayload(representativeEntityId, requestedAmount));
		requestScan();
		return true;
	}
	...
	public boolean requestPickupToSlot(int representativeEntityId, int requestedAmount, int targetSlot) {
		...
		PickupNetworking.sendPickupToSlot(new PickupToSlotRequestPayload(
	...
	public boolean requestDropInventorySlot(int sourceSlot) {
		...
		PickupNetworking.sendDrop(new DropInventorySlotPayload(sourceSlot, DropInventorySlotPayload.ALL_ITEMS));
		requestScan();
		return true;
	}
